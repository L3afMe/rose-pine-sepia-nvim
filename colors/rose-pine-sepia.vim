...
if g:rps_original == 1
  ...
  hi Define guifg=#907AA9 guibg=NONE ctermfg=14 ctermbg=NONE gui=NONE cterm=NONE
  ...
  hi EndOfBuffer guifg=#F5E9DA guibg=#F5E9DA ctermfg=0 ctermbg=0 gui=NONE cterm=NONE
  ...
  hi MatchParen guifg=#D7827E guibg=#EDD7BD ctermfg=NONE ctermbg=NONE gui=BOLD cterm=BOLD
  ...
  hi clojureKeyword guifg=#569F84 guibg=NONE ctermfg=5 ctermbg=NONE gui=NONE cterm=NONE
  ...
  hi LspDiagnosticsDefaultError guifg=#B4637A
  hi LspDiagnosticsDefaultWarning guifg=#EA9D34
  hi LspDiagnosticsDefaultInformation guifg=#569F84
...
lua package.loaded['rose-pine-sepia.shared'] = nil
lua package.loaded['rose-pine-sepia.colors'] = nil
lua package.loaded['rose-pine-sepia.util'] = nil

lua require('rose-pine-sepia').setup({["bg-only"] = false})
